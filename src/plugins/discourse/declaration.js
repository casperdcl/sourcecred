...
export const postRepliesToEdgeType: EdgeType = deepFreeze({
...
export const authorsEdgeType: EdgeType = deepFreeze({
  forwardName: "authors",
  backwardName: "is authored by",
  prefix: EdgeAddress.fromParts(["sourcecred", "discourse", "authors"]),
  defaultWeight: {forwards: 0.5, backwards: 1},
  description: "Connects an author to the content they've created.",
});
